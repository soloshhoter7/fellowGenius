...
export class HttpService {
	...
	registerUser(registrationModel: registrationModel): Observable<Object> {
		return this.http.post('https://backend.fellowgenius.com/fellowGenius/registerUser', registrationModel);
	}
	...
	checkTutorLogin(tutorLoginModel: tutorLoginModel): Observable<Object> {
		return this.http.post('https://backend.fellowgenius.com/authenticateTutor', {
